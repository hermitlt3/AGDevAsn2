...
void SceneText::Init()
{
	...
	MeshBuilder::GetInstance()->GenerateOBJ("BOX1", "OBJ//Gameobject//Crate.obj");
	MeshBuilder::GetInstance()->GenerateOBJ("BOX2", "OBJ//Gameobject//Crate.obj");
	MeshBuilder::GetInstance()->GenerateOBJ("BOX3", "OBJ//Gameobject//Crate.obj");
	MeshBuilder::GetInstance()->GenerateOBJ("BOX4", "OBJ//Gameobject//Crate.obj");

	MeshBuilder::GetInstance()->GetMesh("BOX1")->textureID = LoadTGA("Image//crate_tex.tga");
	MeshBuilder::GetInstance()->GetMesh("BOX2")->textureID = LoadTGA("Image//crate_tex2.tga");
	MeshBuilder::GetInstance()->GetMesh("BOX3")->textureID = LoadTGA("Image//crate_tex3.tga");
	MeshBuilder::GetInstance()->GetMesh("BOX4")->textureID = LoadTGA("Image//crate_tex4.tga");

	// Set up the Spatial Partition and pass it to the EntityManager to manage
	CSpatialPartition::GetInstance()->Init(50, 50, 10, 10);
	CSpatialPartition::GetInstance()->SetMesh("GRIDMESH");
	CSpatialPartition::GetInstance()->SetCamera(&camera);
	CSpatialPartition::GetInstance()->SetLevelOfDetails(90000.0f, 360000.0f);
...

	{
		...
		house->SetType(INVULERABLE);
	}

	{
		GenericEntity* crate = Create::Entity("BOX1", Vector3(10, -5, 0), Vector3(10, 10, 10));
		crate->InitLOD("BOX1", "BOX1", "cube");
		GenericEntity* crate2 = Create::Entity("BOX2", Vector3(0, -5, 10), Vector3(10, 10, 10));
		crate2->InitLOD("BOX2", "BOX2", "cube");
		GenericEntity* crate3 = Create::Entity("BOX3", Vector3(0, -5, -10), Vector3(10, 10, 10));
		crate3->InitLOD("BOX3", "BOX3", "cube");
		GenericEntity* crate4 = Create::Entity("BOX4", Vector3(-10, -5, 0), Vector3(10, 10, 10));
		crate4->InitLOD("BOX4", "BOX4", "cube");
	}
