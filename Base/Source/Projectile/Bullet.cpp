...
void CBullet::SetLength(const float m_fLength)
{
	this->m_fLength = m_fLength;
}

// Get the length of the laser
float CBullet::GetLength(void) const
{
	return m_fLength;
}

// Update this laser
void CBullet::CalculateAngles(void)
{
...
CBullet* Create::Bullet(const std::string& _meshName,
