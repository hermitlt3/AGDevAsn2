...
void SceneText::Init()
{
...

	{
		...
		house->InitLOD("House_HIGH", "House_MED", "House_LOW");
	}
	/*GenericEntity* aCube = Create::Entity("cube", Vector3(-20.0f, 0.0f, -20.0f));
	aCube->SetCollider(true);
	aCube->SetAABB(Vector3(0.5f, 0.5f, 0.5f), Vector3(-0.5f, -0.5f, -0.5f));
	aCube->InitLOD("cube", "sphere", "cubeSG");
	//aCube->boolPhysics() = true;
	//aCube->boolGravity() = true;
	//aCube->boolAcceleration() = true;
	...
	*/
	...
	GroundEntity* crk = Create::Ground("SKYBOX_TOP");
//	Create::Text3DObject("text", Vector3(0.0f, 0.0f, 0.0f), "DM2210", Vector3(10.0f, 10.0f, 10.0f), Color(0, 1, 1));
	...
	crk->SetPosition(Vector3(0, -10, 0));
	crk->SetScale(Vector3(10.0f, 10.0f, 10.0f));
	crk->SetGrids(Vector3(2.0f, 1.0f, 1.0f));
